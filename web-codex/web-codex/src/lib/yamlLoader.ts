  ...
  private async getCategoryFiles(category: CodexCategory): Promise<string[]> {
    const fileMap: Record<CodexCategory, string[]> = {
      sorts: [
        ...
        'amelioration/overclock.yaml',
        'amelioration/poursuite.yaml',
        'amelioration/revelation.yaml',
        'amelioration/sens_a_laffut.yaml',
        'amelioration/silence.yaml',
