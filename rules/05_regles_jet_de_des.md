# Règles de Lancer de Dés et Réussite
...
| Difficulté         | DD  | Description                    |
| ------------------ | --- | ------------------------------ |
| Très facile        | 5   | Presque impossible à rater     |
| Facile             | 10  | Exige un minimum d’attention   |
| Moyenne            | 15  | Nécessite compétence ou chance |
| Difficile          | 20  | Réussite remarquable           |
| Très difficile     | 25  | Rarement atteinte              |
| Presque impossible | 30  | Exploit héroïque               |

> Le MJ ajuste ces valeurs selon les conditions : météo, matériel, blessures, aide, environnement, etc.
...
> Les critiques ne se modifient pas : un 20 reste une réussite totale, même si le total est inférieur au DD.
> Inversement, un 1 reste un échec total, même si le résultat final dépasse le DD.
