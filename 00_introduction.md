...
Des incohérences entre le lore et les statistiques peuvent être présentes : si certaines classes ne semblent pas incarner leur background (ex : un mage avec plus de force que d’intelligence), il s’agit d’une anomalie.
...
Ce document agit comme un **Player Handbook**, présent dans de nombreux jeux de rôle papier.
Il permet au joueur de préparer une partie, d’apprendre les règles en amont et de l’apporter à la table pour pouvoir réfléchir à sa prochaine action du point de vue des règles.

Le document se limite volontairement aux besoins des joueurs : il ne présente pas de scénarios ni de monstres, ces éléments étant à la discrétion du Maître du Jeu (MJ).
Toutefois, une présentation de l’univers, de quelques personnages clés et de moments forts sera donnée à la fin du manuel.
...
caractéristiques, affinités, combat, magie et mécaniques de jeu.
